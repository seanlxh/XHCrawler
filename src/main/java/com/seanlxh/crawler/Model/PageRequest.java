...
public class PageRequest {
    ...
    public PageRequest(String url, Map<String, String> paramMap, Map<String, String> cookieMap, Map<String, String> headerMap, String userAgent, String referrer, boolean ifPost, int timeoutMillis, boolean isValidateTLSCertificates, Proxy proxy) {
        this.url = url;

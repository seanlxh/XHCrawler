...
public class FieldReflectionUtil {
    ...
    public static Date parseDate(Field apiRequestParam, String value) {
        try {
    ...
    public static Object parseValue(java.lang.reflect.Field field, String value) {
        ...
        Field apiRequestParam = field.getAnnotation(Field.class);
